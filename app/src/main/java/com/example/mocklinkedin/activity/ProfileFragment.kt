...
class ProfileFragment : Fragment() {
 ...
 // todo в этом фрагменте сохраняются данные, которые будут видны в этом самом фрагменте и
 //  часть из которых будет видно при публикации поста
    //todo также наплохо было бы сделать фрагмент регистрации и входа в приложени
    // и при регистрации пользователя можно будет увидеть во фраменте списка пользователей.
